...
const Aboutscreen= () => {
  return (
    <section className="w-full">
      ...
      {/* Mission Section */}
      <div className=" flex flex-row px-[120px] items-center">
        <img
          src="/mission.png"
          alt="Mission"
      ...
      {/* Vision Section */}
      <div className="  px-[120px] pb-16 flex flex-row  items-center">
        <div >
          <h2 className="text-[40px] font-bold mb-4">Our Vision</h2>
          <p className="text-[#0a0908] t-[20px] w-[480px] leading-relaxed">
