    ...
    <section className="h-[598px] w-full px-[120px] mt-15 bg-gradient-to-b from-[#0367FC]/30 to-[#F7F7F7]/30 font-family-inter ">
        ...
        <div>
            ...
            <div className="flex flex-row gap-[20px]">
               ...
               <button className=" border border-[#0367fc] mt-[63px] w-[214px] pl-2 h-[60px] rounded-[14px] text-[#0367fc] text-[24px] font-bold flex items-center justify-center hover:bg-[#d2f801] gap-2">Enquire now<ChevronRight className="mt-1" size={30} /></button>
            </div>
        </div>
